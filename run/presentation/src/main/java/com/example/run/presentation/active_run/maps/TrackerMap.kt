...
fun TrackerMap(
    ...
    GoogleMap(
        ...
        RunmatePolylines(locations = locations)

        MapEffect(locations, isRunFinished, triggerCapture, createSnapshotJob) { googleMap ->
            if (isRunFinished && triggerCapture && createSnapshotJob == null) {
                ...
                googleMap.setOnCameraIdleListener {
                    ...
                    createSnapshotJob = GlobalScope.launch {
                        ...
                        delay(500L)
                        googleMap.awaitSnapshot()?.let(onSnapshot)
                    }
                }
                val bmp = googleMap.awaitSnapshot()
            }
        }
